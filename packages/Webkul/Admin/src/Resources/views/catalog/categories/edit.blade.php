<x-admin::layouts>
    ...
    {!! view_render_event('bagisto.admin.catalog.categories.edit.before', ['category' => $a]) !!}

    <!-- Category Edit Form -->
    <x-admin::form :action="route('admin.catalog.categories.update', $a->id)" enctype="multipart/form-data" method="PUT">

        {!! view_render_event('bagisto.admin.catalog.categories.edit.edit_form_controls.before', ['category' => $a]) !!}
        ...
        <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
            ...
            <div class="flex flex-1 flex-col gap-2 max-xl:flex-auto">
                ...
                {!! view_render_event('bagisto.admin.catalog.categories.edit.card.general.before', ['category' => $a]) !!}
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                    ...
                    <x-admin::form.control-group>
                        ...
                        <v-field type="text" name="{{ $currentLocale->code }}[name]"
                            value="{{ old($currentLocale->code)['name'] ?? ($a->translate($currentLocale->code)['name'] ?? '') }}"
                        ...
                        <div>
                            ...
                            <div class="flex flex-col gap-3">
                                <x-admin::tree.view input-type="radio" name-field="parent_id" value-field="id"
                                    id-field="id" :items="json_encode($categories)" :value="json_encode($a->parent_id)" :fallback-locale="config('app.fallback_locale')" />
                            </div>
                        </div>
                    @endif
                </div>

                {!! view_render_event('bagisto.admin.catalog.categories.edit.card.general.after', ['category' => $a]) !!}
                ...
                <div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="textarea" id="description" class="description"
                                name="{{ $currentLocale->code }}[description]" ::rules="{ 'required': isDescriptionRequired }" :value="old($currentLocale->code)['description'] ??
                                    ($a->translate($currentLocale->code)['description'] ?? '')"
                    ...
                    <div class="flex pt-5">
                        ...
                        <div class="flex w-2/5 flex-col gap-2">
                            ...
                            <x-admin::media.images name="logo_path" :uploaded-images="$a->logo_path ? [['id' => 'logo_path', 'url' => $a->logo_url]] : []" />
                        </div>
                        ...
                        <div class="flex w-3/5 flex-col gap-2">
                            ...
                            <x-admin::media.images name="banner_path" :uploaded-images="$a->banner_path ? [['id' => 'banner_path', 'url' => $a->banner_url]] : []" width="220px" />
                        </div>
                    </div>
                </div>

                {!! view_render_event('bagisto.admin.catalog.categories.edit.card.description_images.after', ['category' => $a]) !!}

                {!! view_render_event('bagisto.admin.catalog.categories.edit.card.seo.before', ['category' => $a]) !!}
                    ...
                    <div class="mt-8">
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text" id="meta_title"
                                name="{{ $currentLocale->code }}[meta_title]" :value="old($currentLocale->code)['meta_title'] ??
                                    ($a->translate($currentLocale->code)['meta_title'] ?? '')" :label="trans('admin::app.catalog.categories.edit.meta-title')"
                        ...
                        <x-admin::form.control-group>
                            ...
                            <v-field type="text" name="{{ $currentLocale->code }}[slug]" rules="required"
                                value="{{ old($currentLocale->code)['slug'] ?? ($a->translate($currentLocale->code)['slug'] ?? '') }}"
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text"
                                name="{{ $currentLocale->code }}[meta_keywords]" :value="old($currentLocale->code)['meta_keywords'] ??
                                    ($a->translate($currentLocale->code)['meta_keywords'] ?? '')" :label="trans('admin::app.catalog.categories.edit.meta-keywords')"
                        ...
                        <x-admin::form.control-group class="!mb-0">
                            ...
                            <x-admin::form.control-group.control type="textarea" id="meta_description"
                                name="{{ $currentLocale->code }}[meta_description]" :value="old($currentLocale->code)['meta_description'] ??
                                    ($a->translate($currentLocale->code)['meta_description'] ?? '')"
                ...
                {!! view_render_event('bagisto.admin.catalog.categories.edit.card.seo.after', ['category' => $a]) !!}
            </div>
            ...
            <div class="flex w-[360px] max-w-full flex-col gap-2">
                    ...
                    <x-slot:content>
                        ...
                        <x-admin::form.control-group>
                            ...
                            <x-admin::form.control-group.control type="text" name="position" rules="required|integer"
                                :value="old('position') ?: $a->position" :label="trans('admin::app.catalog.categories.edit.position')" :placeholder="trans('admin::app.catalog.categories.edit.enter-position')" />
                        ...
                        <x-admin::form.control-group>
                            ...
                            @php $selectedValue = old('display_mode') ?? $a->display_mode @endphp
                        ...
                        <x-admin::form.control-group class="!mb-0">
                            ...
                            @php $selectedValue = old('status') ?: $a->status @endphp
                ...
                {!! view_render_event('bagisto.admin.catalog.categories.edit.card.accordion.settings.after', ['category' => $a]) !!}
                ...
                <x-admin::accordion>
                    ...
                    @php $selectedAttributes = old('attributes') ?: $a->filterableAttributes->pluck('id')->toArray() @endphp
        ...
        {!! view_render_event('bagisto.admin.catalog.categories.edit.edit_form_controls.after', ['category' => $a]) !!}

    </x-admin::form>

    {!! view_render_event('bagisto.admin.catalog.categories.edit.after', ['category' => $a]) !!}
