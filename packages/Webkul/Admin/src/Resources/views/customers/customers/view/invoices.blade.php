<div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
    <p class="text-base font-semibold leading-none text-gray-800 dark:text-white">
        @lang('admin::app.customers.customers.view.invoices.count', ['count' => count($k->invoices)])
    </p>
    ...
    <x-admin::datagrid :src="route('admin.customers.customers.view', [
        ...
        <template
            ...
            <template v-else>
                <div
                    class="row grid grid-cols-4 grid-rows-1 items-center border-b border-gray-200 bg-gray-50 px-4 py-2.5 text-sm font-semibold text-gray-600 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
            ...
            <template v-else>
                <div v-if="available.meta.total"
                    ...
                    <div class="flex items-center justify-between gap-1.5">
                        <!-- Order Id -->
                        <p class="text-gray-600 dark:text-gray-300" v-text="`# ${record.order_id}`">
                        </p>

                        <!-- View Button -->
                        <a :href="`{{ route('admin.sales.invoices.view', '') }}/${record.id}`"
                ...
                <div v-else class="table-responsive grid w-full">
                    <div class="grid justify-center justify-items-center gap-3.5 px-2.5 py-10">
                        <!-- Placeholder Image -->
                        <img src="{{ bagisto_asset('images/settings/invoice.svg') }}"
