<div class="box-shadow rounded bg-white p-4 dark:bg-gray-900">
    <div class="flex justify-between">
        ...
        <p class="text-base font-semibold leading-none text-gray-800 dark:text-white">
            @lang('admin::app.customers.customers.view.reviews.count', ['count' => count($k->reviews)])
        </p>
    </div>
            ...
            <template v-else>
                <div v-if="available.meta.total"
                    ...
                    <div class="flex justify-start [&amp;>*]:flex-1">
                        <div class="flex flex-col gap-1.5">
                            ...
                            <!-- Product Name -->
                            <p class="text-gray-600 dark:text-gray-300" v-html="record.product_name">
                            </p>

                            <!-- Review Status -->
                            <p class="text-gray-600 dark:text-gray-300" v-html="record.status">
                            </p>
                        </div>
                        ...
                        <div class="flex flex-col gap-1.5">
                            <!-- Review Rating -->
                            <div class="flex">
                                <x-admin::star-rating :is-editable="false" ::value="record.rating" />
                            </div>

                            <!-- Review Created At -->
                            <p class="text-gray-600 dark:text-gray-300" v-html="record.created_at">
                            </p>
                    ...
                    <div class="flex items-center justify-between gap-x-4">
                        ...
                        <a :href="`{{ route('admin.catalog.products.edit', '') }}/${record.product_id}`" target="_blank"
                ...
                <div v-else class="table-responsive grid w-full">
                    <div class="grid justify-center justify-items-center gap-3.5 px-2.5 py-10">
                        <!-- Placeholder Image -->
                        <img src="{{ bagisto_asset('images/empty-placeholders/reviews.svg') }}"
